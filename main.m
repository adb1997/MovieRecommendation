...
%  rating to movie i
%data set from coursera (Machine Learning by Andrew Ng)
...
%Load movie data set to take new user ratings for movies in the dataset
...
%Prediction for movie recommendations !!!!
